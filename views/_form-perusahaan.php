    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            ...
            <div class="form-group">
                ...
                <select class="form-select" id="payment_channel_perusahaan" name="payment_channel" onchange="document.querySelector('#metode_pembayaran_perusahaan').value = this.options[this.selectedIndex].dataset.paymentchannel" required>
                ...
                <input type="hidden" name="metode_pembayaran" id="metode_pembayaran_perusahaan" value="<?=$channel[0]['code']?>">
            </div>
        </div>
    </div>
